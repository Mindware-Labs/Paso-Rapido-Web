    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm space-y-6 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        <div className="flex flex-col items-center gap-1">
          ...
          <h1 className="text-xl font-extrabold text-gray-900">Crear cuenta</h1>
          <p className="text-sm text-gray-500">Regístrate en Paso Rápido</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            <label className="text-sm font-semibold text-gray-700" htmlFor="nombre">
              Nombre completo
            </label>
            <input
              id="nombre"
