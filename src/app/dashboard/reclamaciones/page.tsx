...
const CLAIMS: Claim[] = [
  {
    id: "c1",
    ticket: "#REC-20260428-001",
    motivo: "Cobro duplicado",
    peaje: "Las Américas",
    fecha: "28 Abr 2026 · 08:42",
    monto: "RD$ 100.00",
    status: "abierta",
  },
  {
    id: "c2",
    ticket: "#REC-20260425-003",
    motivo: "Lectura incorrecta",
    peaje: "La Victoria",
    fecha: "25 Abr 2026 · 17:30",
    monto: "RD$ 100.00",
    status: "en_revision",
  },
  {
    id: "c3",
    ticket: "#REC-20260420-007",
    motivo: "Cobro en peaje cerrado",
    peaje: "Duarte Km 9",
    fecha: "20 Abr 2026 · 11:15",
    monto: "RD$ 100.00",
    status: "resuelta",
  },
  {
    id: "c4",
    ticket: "#REC-20260415-002",
  ...
  {
    id: "c5",
    ticket: "#REC-20260410-005",
    motivo: "TAG no leído",
    peaje: "Las Américas",
    fecha: "10 Abr 2026 · 14:20",
    monto: "RD$ 100.00",
    status: "abierta",
  },
  {
    id: "c6",
    ticket: "#REC-20260405-008",
    motivo: "Cobro duplicado",
    peaje: "La Victoria",
    fecha: "05 Abr 2026 · 07:45",
    monto: "RD$ 100.00",
    status: "resuelta",
  },
];
...
> = {
  ...
  en_revision: {
    badge: "bg-blue-50 text-blue-700 ring-blue-200/50",
    dot: "bg-blue-400",
    label: "En revisión",
  },
  resuelta: {
  ...
  rechazada: {
    badge: "bg-red-50 text-red-600 ring-red-200/50",
    dot: "bg-red-400",
    label: "Rechazada",
  },
};
    ...
    <div className="h-[calc(100vh-3.5rem)] flex flex-col bg-slate-50/50 overflow-hidden">
      <div className="flex-1 w-full space-y-4 px-4 py-5 sm:px-6 lg:px-8 overflow-hidden flex flex-col">
        ...
        <header className="shrink-0 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between border-b border-slate-200 pb-4">
          ...
          <button className="inline-flex shrink-0 items-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-xs font-semibold text-white shadow-sm hover:bg-primary/90 transition-all active:scale-95">
        ...
        <div className="shrink-0 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between rounded-xl border border-slate-200 bg-white p-3.5 shadow-sm">
          ...
          <div className="flex items-center gap-1 rounded-lg bg-slate-100 p-1">
            {(["all", "abierta", "en_revision", "resuelta"] as const).map(
              (f) => (
                <button
                  key={f}
        ...
        <section className="shrink-0 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm flex flex-col flex-1 min-h-0">
          ...
          <div className="hidden sm:grid grid-cols-12 gap-4 border-b border-slate-200 bg-slate-50 px-5 py-3">
            ...
            <div className="col-span-2 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500">
              Monto
            </div>
          </div>
            ...
            {filteredClaims.length > 0 ? (
                ...
                return (
                  ...
                  >
                    <div className="sm:col-span-5 flex items-start gap-3">
                      <span
                        className={`mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${sc.badge}`}
                      >
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="mt-1 text-xs text-slate-500">
                  No hay reclamaciones con esos filtros.
                </p>
                <button
                  onClick={() => {
                    setSearchTerm("");
