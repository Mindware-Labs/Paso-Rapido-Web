      ...
      <div className="mx-auto max-w-3xl px-5 sm:px-8">
        ...
        >
          ...
          <h2 className="mt-6 text-[38px] font-bold leading-[1.05] tracking-[-0.03em] text-[#0a0a0a] sm:text-[50px]">
            Preguntas <span className="pr-accent">frecuentes</span>.
          </h2>
            ...
            return (
              <motion.div
                ...
                className={`overflow-hidden rounded-xl border bg-white transition-all duration-300 ${
                  isOpen
                    ? "border-[#0f9d58]/30 shadow-[0_1px_2px_rgba(10,10,10,0.03),0_20px_40px_-28px_rgba(15,157,88,0.22)]"
                    : "border-black/8 shadow-[0_1px_2px_rgba(10,10,10,0.03)] hover:border-black/15 hover:shadow-[0_1px_2px_rgba(10,10,10,0.04),0_16px_36px_-28px_rgba(10,10,10,0.10)]"
                }`}
              >
                <button
                ...
                >
                  ...
                  <motion.span
                    ...
                    className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-md transition-colors ${
                      isOpen
                        ? "bg-[#0f9d58] text-white shadow-[0_4px_10px_-2px_rgba(15,157,88,0.4)]"
                        : "bg-neutral-100 text-neutral-600 ring-1 ring-black/5"
                    }`}
                  >
